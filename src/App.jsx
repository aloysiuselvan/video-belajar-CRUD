...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/manage-courses" element={<ManageCoursesList courses={courses} setCourses={setCourses} />} />
      <Route path="/manage-courses/add" element={<ManageCourseForm courses={courses} setCourses={setCourses} />} />
      <Route path="/manage-courses/edit/:id" element={<ManageCourseForm courses={courses} setCourses={setCourses} />} />
    </Routes>
  );
}
